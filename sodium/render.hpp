        ...
        if (menuAlpha > 0.0f)
        {
            ...
            ImGui::Begin("Overlay", nullptr, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize);
            {
                if (ImGui::BeginTabBar("main"))
                {
                    ...
                    {
                        ImGui::BeginChild("aiming", ImVec2(400, 400), true);
                        ...
                        ImGui::SliderFloat("smoothness x", &settings::aimbot::smoothness_x, 1, 30);

                        ImGui::SliderFloat("smoothness y", &settings::aimbot::smoothness_y, 1, 30);

                        ImGui::Checkbox("show fov", &settings::aimbot::show_fov);
                        ImGui::SameLine(); ImGui::Checkbox("disable outside fov", &settings::aimbot::disable_outside_fov);
                        ...
                        if (settings::aimbot::show_fov) {
                            ...
                            drawList->AddCircle(
                                ...
                                100000, // Number of sides
                                0.75f // Thinner outline thickness
                            );
                            ...
                            drawList->AddCircle(
                                ...
                                100000, // Number of sides
                                0.75f // Thinner inline thickness
                            );
                        ...
                        ImGui::BeginChild("triggerbot", ImVec2(400, 400), true);

                        ImGui::Text("triggerbot");
                        ImGui::Separator();

                        ImGui::Checkbox("enable triggerbot", &settings::triggerbot::enable_triggerbot);
                        ImGui::SliderInt("delay", &settings::triggerbot::triggerbot_delay, 1, 50);
                        ImGui::SliderInt("distance", &settings::triggerbot::triggerbot_distance, 10, 50);
                    ...
                    if (ImGui::BeginTabItem("settings"))
                    {
                        ...
                        //ImGui::Checkbox("death check", &settings::checks::death_check);
                    ...
                    //{
                        //ImGui::BeginChild("exploits", ImVec2(400, 400), true);
